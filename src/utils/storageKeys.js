...
/** Per-habit target schedule: effectiveFrom Monday → targetDays (rank weekly denominator history). */
export const STORAGE_HABIT_TARGET_HISTORY = 'habit-tracker-habit-target-history'
...
/** Dev only: shifts virtual “today” forward by N calendar days (after month offset). */
export const STORAGE_TEST_TIME_OFFSET_DAYS = 'habit-tracker-test-time-offset-days'
